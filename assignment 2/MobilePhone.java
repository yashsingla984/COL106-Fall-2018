...
class MobilePhone
{
	...
	public boolean equals(Object o)          //using equals function to compare objects as it is not directly comparable like integer
	{
		MobilePhone e=(MobilePhone) o;
		return e.newmobile==this.newmobile;
	}
}